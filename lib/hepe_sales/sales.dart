...
//   @override
//   _HepeSalesPageState createState() => _HepeSalesPageState();
// }
...
//       var getDsales = await getCustomerYearlySales(
//           element['salesman_code'], SalesData.overallSalesType.toUpperCase());
...
//       var getDsales = await getCustomerMonthlySales(
//           element['salesman_code'], SalesData.overallSalesType.toUpperCase());
...
//       var getDsales = await getCustomerWeeklySales(
//           element['salesman_code'], SalesData.overallSalesType.toUpperCase());
...
//       var getDsales = await getCustomerDailySales(
//           element['salesman_code'], SalesData.overallSalesType.toUpperCase());
...
//       var getDsales = await getYearlySales(
//           element['salesman_code'], SalesData.overallSalesType.toUpperCase());
...
//       var getDsales = await getMonthlySales(
//           element['salesman_code'], SalesData.overallSalesType.toUpperCase());
...
//       var getDsales = await getWeeklySales(
//           element['salesman_code'], SalesData.overallSalesType.toUpperCase());
...
//     print('DAILY' + _sList.toString());
//     SalesData.salesToday = totalSales.toStringAsFixed(2);
//     print(SalesData.salesToday);
//     viewSpinkit = false;
